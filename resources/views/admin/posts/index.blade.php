...
@section('content')
    <div class="card">
        <div class="card-body">
            <a href="/posts/create" class="btn btn-purple">Tambah post</a>
            <table class="table">
                <tr>
                    <th>No</th>
                    <th>Judul</th>
                ...
                @foreach ($posts as $post)
                    <tr>
                        ...
                        <td class="d-flex">
                            <button class="btn btn-info me-2 btn-sm" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#postDetail{{ $post->id }}">
