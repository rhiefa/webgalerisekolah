...
<div class="container">
    <div class="card">
        <div class="card-body">
            <a href="/galleries/create" class="btn btn-purple">Tambah Galeri</a>
            <table class="table">
                <tr>
                    <th>No</th>
                    <th>Judul Post</th>
                ...
                <tr>
                    ...
                    <td>
                        @if ($gallery->status == 'aktif')
                                    <span class="badge bg-success text-ligt">{{ Str::ucfirst($gallery->status) }}</span>
                                @else
                                    <span class="badge bg-warning text-ligt">{{ Str::ucfirst($gallery->status) }}</span>
                                @endif
                    </td>
